...
export default function AccountView({ user, subscription, usedThisMonth, upgraded }: Props) {
    ...
    <main className="max-w-2xl mx-auto px-4 py-8">
      ...
      <section className="bg-surface rounded-lg p-5 border border-accent-dim/20">
        ...
        {user.plan === 'free' ? (
          ...
          <div>
            <p className="text-text-primary">Pro plan — active until {format(new Date(subscription.currentPeriodEnd), 'MMM d, yyyy')}</p>
